...
- Strategic depth: some squares have different styles/difficulties of map
- Uses TMX map packs for curated map selection

## Settings

Access settings via integrated plugin settings menu (dev settings in openplanet menu):
