...
2. Place your sound files in this folder with these exact names:
   ...
   - **check.wav** - Check
   - **checkmate.wav** - Checkmate/Game End
   - **castle.wav** - Castling
   - **game-start.wav** - Game Start
   - **move-opponent** - Opponents Move

3. Supported formats: `.wav`, `.mp3`, `.flac`, `.ogg`

4. Restart the plugin or reload it to load the new sounds
...
- **Use Game Sounds** - Toggle game sounds (default: ON)
