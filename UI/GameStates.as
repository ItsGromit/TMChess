...
void RenderInLobbyState() {
    ...
    // Reset cursor and add "Lobby" label with ID as a button-style element
    UI::SetCursorPos(lockCursor);
    ...
    string lobbyLabel = "Lobby" + (currentLobbyId.Length > 0 ? ": " + currentLobbyId : "");
    UI::Button(lobbyLabel, vec2(0, barHeight));
    UI::PopStyleColor(3);
